...
import api.endpoints.UserEndPoints2FromProperties;
import api.playload.User;
import io.restassured.response.Response;

public class UserTests2FromProperties {
	...
	public void createUserTest() {
		...
		Response createUserResponse = UserEndPoints2FromProperties.createUser(userPlayload);
	...
	public void getUserTest() {
		Response getUserResponse = UserEndPoints2FromProperties.getUser(this.userPlayload.getUsername());
	...
	public void updateUserTest() {
		...
		Response updateUserResponse = UserEndPoints2FromProperties.updateUser(this.userPlayload.getUsername(), userPlayload);
	...
	Response deleteUserResponse = UserEndPoints2FromProperties.deleteUser(this.userPlayload.getUsername());
